...
if (-Not (Test-Path .\archives_Hollman))
{
    mkdir .\archives_Hollman | Out-Null
}
...
$zipfile = @{
    ...
    DestinationPath = ".\archives_Hollman\empdata01"
}
...
if (-Not (Test-Path .\extracted_files_Hollman))
{
    mkdir .\extracted_files_Hollman | Out-Null
}

#unzip the csv file into the extracted_file subdirectory
Expand-Archive -Path .\archives_Hollman\empdata01.zip -DestinationPath .\extracted_files_Hollman -Force
